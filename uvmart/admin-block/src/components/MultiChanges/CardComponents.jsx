  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', ...sx }}>
      <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
        <Typography variant={variant} gutterBottom={gutterBottom} sx={{ mr: 0.5 }}>
          <strong>{head} : </strong>
        </Typography>
        {showCopy ? (
...
export const TextFiledScorall = ({
  variant = "h6",
  head,
  details,
  gutterBottom = false,
  sx = { maxWidth: 250, overflowX: 'auto', whiteSpace: 'nowrap', display: 'block' },
  showCopy = false,
}) => {
  return (
...
export const TextFiledHorizontalScorall = ({
  variant = "h6",
  head,
  details,
  gutterBottom = false,
...
export const TextFileMultiplesThings = ({
  head,
  details = [],
  variant = "body2",
  gutterBottom = false,
...
export const TextItems = ({
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', mb: 1 }}>
      <Typography variant={variant} gutterBottom={gutterBottom} sx={{ mb: 1 }}>
        <strong>{head}:</strong>
      </Typography>
