...
function UserProfile() {
  ...
  return (
    <Card className="p-6 m-7 max-w-md mx-auto rounded-xl shadow-md overflow-hidden ">
      <Typography className="flex justify-center text-3xl font-bold font-color-sigin mb-8" variant="h5">User Profile</Typography>
        ...
        {isGoogleUser ? (
          ...
          <>
            ...
            <Box sx={{ display: 'flex',justifyContent: "space-between", gap:1, m: 2 }}>
              <Button className={`${classes.siginbutton}`} style={{width: "150px"}}  onClick={handleSave}>Save</Button>
              <Button className={`${classes.siginbutton}`} style={{width: "150px"}} onClick={() => setIsEditing(false)}>Cancel</Button>
            </Box>
          </>
        )}
      </Box>
